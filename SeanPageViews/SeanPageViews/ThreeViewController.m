...
#import "MJRefresh.h"
@interface ThreeViewController ()<UITableViewDelegate,UITableViewDataSource,SeanPageViewDelegate>
@property (nonatomic,strong) UITableView *tableView;
@property (nonatomic,copy) void (^scrollCallback)(UIScrollView *scroll);@end
